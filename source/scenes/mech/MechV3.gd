...
func setup(var my_arena):
	...
	mech_parts.wpn_l.obj = load(mech_parts.wpn_l.path).instance()
	mech_parts.wpn_l.obj.rotation_degrees.y = 180
	mech_parts.arm_l.obj.get_node("Armature/Skeleton/Hand").add_child(mech_parts.wpn_l.obj)
	
	mech_parts.wpn_r.obj = load(mech_parts.wpn_r.path).instance()
	mech_parts.wpn_r.obj.rotation_degrees.y = 180
	mech_parts.arm_r.obj.get_node("Armature/Skeleton/Hand").add_child(mech_parts.wpn_r.obj)
